...
//
// const WalletComponent = ({doGetPosts, loading, allPosts}) => {
//     useEffect(() => {
//         doGetPosts()
//     }, [doGetPosts])
//
//     return (
//         <div className={'container text-center'} style={{margin: '0 auto', textAlign: 'center', alignItems: 'center'}}>
//             <div className={'row'}>
